  ...
  return (
    <div className="rounded-2xl border border-border/70 bg-background/30 p-3 sm:p-4">
      <div className="mb-3">
        ...
        <p className="text-xs text-muted-foreground">Quantidade, receita média e créditos consumidos</p>
      </div>
            ...
            <div key={row.key} className="rounded-xl border border-border/50 bg-card/30 p-3">
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">{formatCurrency(row.revenue)}</p>
                </div>

                <div className="shrink-0 text-right">
                  <p className="text-[11px] text-muted-foreground">Qtd.</p>
                  <p className="text-lg font-bold tabular-nums text-sky-500">{row.count}</p>
                </div>
              </div>
              ...
              <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="rounded-lg bg-cyan-500/10 px-2 py-2">
                  ...
                  <p className="mt-0.5 font-semibold tabular-nums text-cyan-500">
